...
Чтобы вычислить апостериорные вероятности классов классифицируемого объекта, необходимо воспользоваться функциями правдоподобия каждого класса. Объект примет тот класс, апостериорная вероятность которого будет максимальной.  
